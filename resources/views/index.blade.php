  ...
  <body>
    ...
    <section class="home-full-slider-wrapper mb-10px">
      ...
      <div class="owl-carousel owl-theme owl-dots-modern home-full-slider">
        <div style="background: #f8d5cf;" class="item home-full-item"><img src="img/photo/matheus-ferrero-334418-unsplash.jpg" alt="" class="bg-image">
        ...
        <div class="item home-full-item bg-dark dark-overlay"><img src="img/photo/ian-dooley-347942-unsplash.jpg" alt="" class="bg-image">
        ...
        <div class="item home-full-item"><img src="img/photo/haley-phelps-62815-unsplash.jpg" alt="" class="bg-image">
          <div class="container-fluid h-100">
            <div class="row align-items-center h-100">
              <div class="col-lg-8 col-xl-6 mx-auto text-white text-center">
